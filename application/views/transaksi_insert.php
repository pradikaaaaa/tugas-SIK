...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="quantity" id="quantity" class="form-control" min="1" max="9999">
                </div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <div class="panel panel-default">
            ...
            <input type="hidden" id="dtp_input1" value="<?php echo date("Y-m-d");?>" name="tgl_transaksi" />
            <input type="hidden" id="dtp_input4" value="<?php echo date("Y-m-d");?>" name="tgl_pengiriman" />
            <input type="hidden" id="dtp_input2" value="<?php echo date("Y-m-d");?>" name="tgl_produksi" />
            <input type="hidden" id="dtp_input3" value="<?php echo date("Y-m-d");?>" name="tgl_selesai" />
